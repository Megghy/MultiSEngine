namespace MultiSEngine.Events
{
    ...
    {
        public RecieveCustomPacketEventArgs(ClientData client, INetPacket p, BinaryReader reader)
        {
            Client = client;
            Reader = reader;
            Packet = p;
    ...
    {
        public SendDataEventArgs(ClientData client, INetPacket packet, bool toClient)
        {
            Client = client;
            Packet = packet;
            ToClient = toClient;
        ...
        public ClientData Client { get; private set; }
        public INetPacket Packet { get; set; }
    ...
    {
        public GetDataEventArgs(ClientData client, INetPacket packet, bool fromClient)
        {
            Client = client;
            Packet = packet;
