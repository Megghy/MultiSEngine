...
namespace MultiSEngine.Events
{
    public class Hooks
    {
        ...
        internal static bool OnRecieveCustomData(ClientData client, INetPacket packet, BinaryReader reader, out RecieveCustomPacketEventArgs args)
        {
        ...
        /*internal static bool OnSendData(ClientData client, INetPacket packet, bool toClient, out SendPacketEventArgs args)
        {
